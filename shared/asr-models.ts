...
export const ASR_MODELS: readonly AsrModelEntry[] = [
  {
    ...
    label: 'Whisper Tiny', sizeLabel: '~176MB', language: 'Chinese / English', note: 'Fastest and lightest, good for low-spec machines; accuracy is only fair.',
  },
  {
    ...
    label: 'Whisper Base', sizeLabel: '~351MB', language: 'Chinese / English', note: 'Light and balanced, fine for everyday talking-head audio; timestamped transcription is faster.',
  },
  {
    ...
    label: 'Whisper Small', sizeLabel: '~1.0GB', language: 'Chinese / English', note: 'Recommended: balanced Chinese/English recognition, Simplified Chinese output, stable word-level timestamps.',
  },
  {
    ...
    label: 'Whisper Medium', sizeLabel: '~743MB', language: 'Chinese / English', note: 'Highest accuracy but large and slower to transcribe; pick it when quality matters most.',
  },
];
