...
1. Ask the user to re-link the asset in My Media (offline media banner) or re-import the file.
...
- "Quick local export"
- "The asset is still uploading, export in a moment"
- "The local asset needs to be re-linked first"
