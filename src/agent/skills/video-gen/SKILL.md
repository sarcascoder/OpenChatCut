...
- "one clip / single clip / just one / a single shot / in 1 clip" → never split, even if the description is objectively long.
- "N shots / N segments / N cuts" → generate exactly N.
